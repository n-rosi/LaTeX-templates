...
\publicationsEntry{Sept 2021}
{Journal Article}{"Optimizing Large-Scale Machine Learning Models for Healthcare Analytics"}{\href{https://journal.example.com/article}{journal.example.com/article}}
\publicationsEntryConference{Aug 2020}
{Conference Presentation}{"Advanced Techniques in Data Science for Predictive Analytics"}{\href{https://conference.example.com/talk}{conference.example.com/talk}}
\publicationsEntry{Aug 2019}
{Journal Article}{"Optimizing Large-Scale Machine Learning Models for Healthcare Analytics"}{\href{https://journal.example.com/article}{journal.example.com/article}}
\publicationsEntryConference{June 2019}
{Conference Presentation}{"Advanced Techniques in Data Science for Predictive Analytics"}{\href{https://conference.example.com/talk}{conference.example.com/talk}}
\end{document}
